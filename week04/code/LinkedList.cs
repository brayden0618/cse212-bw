    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // then we can call remove_head to remove it.
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If the location of 'value' is at the end of the list,
                // then we can call remove_tail to remove it.
                else if (curr == _tail)
                {
                    RemoveTail();
                }
                // For any other location of 'value', need to reconnect
                // the links to remove it.
                else
                {
                    curr.Prev!.Next = curr.Next; // Connect node before 'value' to node after 'value'
                    curr.Next!.Prev = curr.Prev; // Connect node after 'value' to node before 'value'
                }
